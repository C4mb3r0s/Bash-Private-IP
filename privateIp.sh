...
echo -e "\n${yellowColour}[+]${endColour} ${blueColour}Esta es tu dirección IP Privada${endColour} ${greenColour}->${endColour} ${redColour}$(ip a | grep wlp1s0 | tail -n 1 | awk '{print $2}' | awk '{print $1}' FS="/")${endColour}\n"
